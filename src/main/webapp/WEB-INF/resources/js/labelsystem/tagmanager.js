...
$('#tb_powerset').bootstrapTable({  
     ...
     columns: [{  
         ...
         title: '操作',  
         formatter: function(value, row, index){
            return '<span class="open_stop" level="'+value+'"><img src="../../image/user_open.png" alt="" style="width:17px;"/></span><span class="oneEdit" level="'+value+'"><img src="../../image/user_edit" alt="" style="width:14px;"/></span><span class="commondel" level="'+value+'"><img src="../../image/55.png" alt=""></span>'  
         } 
     }],  
     detailView:true,  
