                ...
                if (item[options.parentColumn] == parentNode[options.id]) {
                    ...
                    $.each(options.columns, function (index, column) {
                        ...
                        if(index == 0){
                            ...
                            tr.append(td);
                            tr.append("<td><span class='main_openStop'><img src='../../image/user_stop.png'></span><span class='labelEdit' data-toggle='modal' data-target='#maineditModal'><img src='../../image/user_edit.png'></span><span class='commondel'><img src='../../image/55.png'></span></td>")
                        }
                    });
                    tbody.append(tr);
